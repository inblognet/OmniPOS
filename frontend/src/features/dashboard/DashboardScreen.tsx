...
const DashboardScreen: React.FC = () => {
  ...
  // ✅ ONLY CHANGE: Added 'all' and set it as the default view
  ...
  // ✅ ONLY CHANGE: Data slicing logic to support 'all'
  const visibleTrends = trendView === '7' ? trends.slice(-7) : trendView === '30' ? trends.slice(-30) : trends;
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex bg-gray-100 rounded-lg p-1">
            ...
            {/* ✅ ONLY CHANGE: Added the All Time button using your original styling */}
            <button onClick={() => setTrendView('all')} className={`px-3 py-1 text-xs font-bold rounded-md transition-all ${trendView === 'all' ? 'bg-white shadow text-blue-600' : 'text-gray-500'}`}>All Time</button>
          </div>
        </div>
