        ...
        <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={() => setShowShortcuts(false)}>
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-4 space-y-2">
                    <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded"><span className="text-sm text-gray-600">Toggle Fullscreen</span><span className="text-xs font-mono bg-gray-200 px-2 py-1 rounded border border-gray-300">F11</span></div>
                    <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded"><span className="text-sm text-gray-600">Print Last Receipt</span><span className="text-xs font-mono bg-gray-200 px-2 py-1 rounded border border-gray-300">Ctrl + P</span></div>
                    <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded"><span className="text-sm text-gray-600">Quick Search</span><span className="text-xs font-mono bg-gray-200 px-2 py-1 rounded border border-gray-300">Ctrl + K</span></div>
                    <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded"><span className="text-sm text-gray-600">New Sale</span><span className="text-xs font-mono bg-gray-200 px-2 py-1 rounded border border-gray-300">Alt + N</span></div>
                </div>
